...
testAbs1(void) {
    float s1 = abs1(-1);
    ensure(floatEqual(s1, 1), "abs1 test error 1");
    //
    float s2 = abs1(1);
    ensure(floatEqual(s2, 1), "abs1 test error 2");
}
...
testMin1(void) {
    ...
    //
    vector<float> v2 = { 1, 2, 3, 4, 5, -2, -1 };
    float s2 = min1(v2);
    ensure(floatEqual(s2, -2), "min1 test error 2");
}
...
testSum1(void) {
    float s1 = sum1(3);
    ensure(floatEqual(s1, 2), "sum1 test error 1");
    //
    float s2 = sum1(2);
    ensure(floatEqual(s2, -1), "sum1 test error 2");
}
...
testSum2(void) {
    float s1 = sum2(3);
    ensure(floatEqual(s1, 0), "sum2 test error 1");
    //
    float s2 = sum2(2);
    ensure(floatEqual(s2, 3), "sum2 test error 2");
    //
    float s3 = sum2(1);
    ensure(floatEqual(s3, 1), "sum2 test error 2");
}
...
testFac1(void) {
    float s1 = fac1(3);
    ensure(floatEqual(s1, 6), "fac1 test error 1");
    //
    float s2 = fac1(2);
    ensure(floatEqual(s2, 2), "fac1 test error 2");
    //
    float s3 = fac1(1);
    ensure(floatEqual(s3, 1), "fac1 test error 2");
}
